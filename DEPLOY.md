...
```text
https://<guest-port>-<sandbox-id>.qa6-agent-sandbox.sprinklr.com/
```
...
- `api.qa6-agent-sandbox.sprinklr.com` DNS points to the ingress controller/load balancer.
- `*.qa6-agent-sandbox.sprinklr.com` DNS points to the same ingress controller/load balancer.
