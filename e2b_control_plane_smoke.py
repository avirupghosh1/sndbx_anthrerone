...
from e2b import PtySize, Sandbox, Template
...
TEMPLATE_NAME = os.environ.get("TEMPLATE_NAME") or f"e2b-python-smoke-{RUN_ID}"
BACKGROUND_TEMPLATE_NAME = os.environ.get("BACKGROUND_TEMPLATE_NAME") or f"{TEMPLATE_NAME}-bg"
