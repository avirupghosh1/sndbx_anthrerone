...
- As current url’s are not ca certified
  ...
  **“https://*.qa6-agent-sandbox.sprinklr.com”** won’t work so we need to inject sandbox_url **“http://49983-{sid}.qa6-agent-sandbox.sprinklr.com”** after every create using a reconnect. the code patch is like this,
